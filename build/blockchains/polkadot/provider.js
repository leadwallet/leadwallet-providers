...
var PolkadotProvider = /** @class */ (function () {
    function PolkadotProvider(rpcUrl) {
        if (rpcUrl === void 0) { rpcUrl = "https://dot.getblock.io" +
        ...
        this._rpc = rpcUrl
            ...
            : new common_1.RpcServer("https://dot.getblock.io" + network);
    }
    ...
    PolkadotProvider.prototype.submitExtrinsic = function () {
